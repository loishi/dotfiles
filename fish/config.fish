...
alias ll "exa -al"
alias nv "nvim"
alias bu "sudo tlmgr update -all -self && brew update && brew upgrade && brew upgrade --cask && pip list -o --format=freeze | grep -v '^\-e' | cut -d = -f 1 | xargs -n1 pip install -U pip && rustup update stable"
