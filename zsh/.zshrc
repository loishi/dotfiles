...
alias la="lsd -a"
alias nv="nvim"
alias bu="brew update || true && brew upgrade || true && brew upgrade --cask --greedy-auto-updates --greedy-latest --no-quarantine || true && brew cleanup --prune=all || true && brew autoremove || true && tldr -u || true && rustup update stable"
