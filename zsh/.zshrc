...
alias la="lsd -a"
alias nv="nvim"
alias bu="brew update || true && brew upgrade || true && brew upgrade --cask --greedy-auto-updates --greedy-latest || true && brew upgrade --cask chromium wezterm-nightly --no-quarantine --greedy-latest || true && brew cleanup || true && brew autoremove || true && tldr -u || true && rustup update stable"
