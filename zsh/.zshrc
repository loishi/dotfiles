...
alias sf="python3 ~/x/git/external-engine/example-provider.py --name M2 --token lip_Wulon0XAyfys5RTyifCy --engine ~/x/git/Stockfish/src/stockfish --max-hash 4096 --default-depth 50"
