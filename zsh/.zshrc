...
alias ll="exa -al"
alias nv="nvim"
alias bu="aud && sudo tlmgr update -all -self --reinstall-forcibly-removed || true && brew update && brew upgrade && brew upgrade --cask && brew upgrade --cask wezterm-nightly --no-quarantine --greedy-latest && pip3 list -o --format=freeze | rg -v '^\-e' | cut -d = -f 1 | xargs -n1 pip3 install -U pip | rg -v 'DEPRECATION|satisfied' || true && rustup update stable"
